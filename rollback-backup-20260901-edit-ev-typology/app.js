  ...
  if (key === "strategicUnifiedEV" || key === "strategicUnifiedTop5") {
    ...
    return {
      ...
      metrics: [
        ...
        { label: "Custo ponderado", value: area ? `${money(validValue / area)}/m²` : "Sem leitura" },
      ],
  ...
  return `
    ...
    <section class="strategic-hero panel">
        ...
        <div class="strategic-main-kpi__body">
          ...
          <span class="strategic-main-copy">
            ...
            <span class="strategic-main-breakdown">
              ...
              <span data-tone="orange"><i></i><b>${validAreaRecords.length}</b><small>Com R$/m²</small></span>
            </span>
          </span>
        </div>
      ...
      <div class="strategic-hero-metrics">
        ...
        ${strategicHeroMetric("Custo ponderado", weightedCostM2 ? `${money(weightedCostM2)}/m²` : "Sem leitura", `${validAreaRecords.length} EVs com área válida`, "R$/m²", "green", 100)}
    ...
    <section class="strategic-kpis">
      ...
      ${executiveKpi("Custo ponderado m²", weightedCostM2 ? `${money(weightedCostM2)}/m²` : "Sem leitura", `${validAreaRecords.length} leituras válidas`, "Valor dos EVs válidos dividido pela área válida", "orange", "strategicUnifiedEV", "R$/m²")}
