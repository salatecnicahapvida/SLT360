...
function renderSicKpis(data, mode = "default") {
  ...
  return `
    <section class="kpi-grid sic-kpi-grid">
      ...
      ${kpi("SICs e aditivos", String(data.uniqueSics), `${data.records.length} linhas extraídas dos EVs`, "blue", "", "sicTotal")}
    </section>
  `;
}
