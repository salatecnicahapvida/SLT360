...
Para demandas do tipo **SIC**, o fluxo do Kanban passa por **Aguardando Validação Obras** → **Validado Obras** → **Aguardando Aprovação Diretoria** → **Aprovado Pela Diretoria** → **Concluído**. A passagem de **Aguardando Validação Obras** para **Validado Obras** pode ser feita por qualquer usuário com permissão de edição em Obras. Somente usuários **Gestor** ou **Admin** com permissão de escrita em Obras podem executar a passagem de **Validado Obras** para **Aguardando Aprovação Diretoria**. A passagem seguinte, de **Aguardando Aprovação Diretoria** para **Aprovado Pela Diretoria**, não exige mais perfil de Gestor/Admin. Uma SIC só pode entrar em **Concluído** quando já estiver em **Aprovado Pela Diretoria**.
