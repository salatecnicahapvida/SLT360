        ...
        <table class="data-table strategic-intelligence-table">
          ...
          <tbody>
            ${investmentRows.slice(0, 15).map((row, index) => {
              ...
              const benchmark = typologyCostBenchmarks.get(row.record.typology || "Não informada") || globalCostBenchmark || 0;
