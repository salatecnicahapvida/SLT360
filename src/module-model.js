...
export const ENTITIES = [
  ...
  entity('budget_sic_items','budget',null,{disciplinaId:'discipline_id',valorAnterior:money('previous_amount'),valorNovo:money('new_amount'),valorDelta:money('delta_amount')},{parent:'budget_sics',child:'disciplinasAfetadas',key:'disciplinaId'}),
