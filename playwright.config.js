...
export default defineConfig({
  ...
  use:{baseURL:process.env.PLAYWRIGHT_BASE_URL||'http://127.0.0.1:4173/',headless:true,channel:process.platform==='win32'?'msedge':undefined,viewport:{width:1440,height:1000}},
